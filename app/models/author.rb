class Author
  ...
  def articles
    ...
    p "Hi, #{self}, here are all of your articles:"
    Article.all.select {|article| article.author == self}
  end

  def magazines
    # - Returns a **unique** array of Magazine instances for which the author has contributed to
    p "Hi, #{self}, here are all of the magazines you have contributed to:"
    self.articles.map {|article| article.magazine}.uniq
  end

    def magazine_articles(magazine)
    # - Returns a **unique** array of Magazine instances for which the author has contributed to
    p "Hi, #{self}, here are all of the articles you have submitted to #{magazine}:"
  ...
  def add_article(magazine, title)
    ...
    p "#{self}, wrote a new article called, #{title}, for #{magazine} magazine."
  ...
  def topic_areas
    ...
    p "Hi, #{self}, here are all of the catagories you have contributed to:"
